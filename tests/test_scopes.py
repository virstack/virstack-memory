...
class TestActiveGroupId:
    ...
    def test_project_workspace_agent(self, client: MemoryClient) -> None:
    ...
    def test_special_characters_in_ids(self, client: MemoryClient) -> None:
    ...
    def test_numeric_ids(self, client: MemoryClient) -> None:
...
class TestHierarchyBuilders:
    ...
    def test_customer_returns_memory_scope(self, client: MemoryClient) -> None:
    ...
    def test_skip_agent_level(self, client: MemoryClient) -> None:
